...
export default function CaseStudies() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <div className="bg-gradient-mesh text-white py-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {caseStudies.map((study) => (
              <Card key={study.id} className={`bg-gradient-to-br ${study.color} hover:shadow-lg transition-all duration-300 border-0 group`}>
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <div className="font-semibold text-navy-blue text-sm">Challenge</div>
                        <div className="text-blue-grey text-sm">{t(study.challengeKey)}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <div className="font-semibold text-navy-blue text-sm">Solution</div>
                        <div className="text-blue-grey text-sm">{t(study.solutionKey)}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <div className="font-semibold text-navy-blue text-sm">Result</div>
                        <div className="text-blue-grey text-sm">{t(study.resultKey)}</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
