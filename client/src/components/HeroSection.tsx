...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="pt-20 min-h-screen flex items-center gradient-blue-green">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-playfair font-bold text-charcoal leading-tight">
                ...
                <span className="text-ocean-blue">automation</span> and{" "}
                <span className="text-forest-green">AI</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="bg-ocean-blue text-white px-8 py-4 rounded-lg font-semibold hover:bg-ocean-blue/90 transition-colors text-lg"
              >
              ...
              <Button
                ...
                className="border-2 border-ocean-blue text-ocean-blue px-8 py-4 rounded-lg font-semibold hover:bg-ocean-blue hover:text-white transition-colors text-lg"
              >
                Learn More
              </Button>
            </div>
            ...
            <div className="flex items-center space-x-8 pt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-ocean-blue">50+</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 bg-ocean-blue text-white p-4 rounded-xl shadow-lg">
