...
const translations = {
  en: {
    ...
    "caseStudies.case1.description": "Designed a mobile application for an association to help 200+ members connect more effectively and move away from overcrowded WhatsApp groups.",
    "caseStudies.case1.challenge": "Replace chaotic WhatsApp communication",
    "caseStudies.case1.solution": "Custom mobile app with organized communication",
    ...
    "caseStudies.case2.description": "Assisted a healthcare startup in developing an AI system for accurate pneumonia classification from medical imaging.",
    ...
    "caseStudies.case3.description": "Delivered comprehensive 15-hour data analysis training program to public sector employees.",
    "caseStudies.case3.challenge": "Upskill government workforce in data analysis",
    ...
    "caseStudies.case4.description": "Created an AI-powered assistant for law professionals to interact with and query their legal data effectively.",
    "caseStudies.case4.challenge": "Efficient legal data management and querying",
    ...
    "caseStudies.case5.description": "Conducted 16-hour intensive AI training program for IT professionals, focusing on practical workplace applications.",
  ...
  fr: {
    ...
    "caseStudies.case1.description": "Conception d'une application mobile pour une association afin d'aider plus de 200 membres à se connecter plus efficacement et à s'éloigner des groupes WhatsApp encombrés.",
    "caseStudies.case1.challenge": "Remplacer la communication chaotique WhatsApp",
    "caseStudies.case1.solution": "Application mobile personnalisée avec communication organisée",
    ...
    "caseStudies.case2.description": "Assistance à une startup de santé dans le développement d'un système IA pour la classification précise de la pneumonie à partir d'imagerie médicale.",
    "caseStudies.case2.challenge": "Automatisation du diagnostic médical précis",
    "caseStudies.case2.solution": "Système de classification d'images alimenté par IA",
    "caseStudies.case2.result": "Précision diagnostique améliorée",
    
    "caseStudies.case3.date": "Novembre 2024",
    "caseStudies.case3.title": "Formation en Analyse de Données pour Fonctionnaires",
    "caseStudies.case3.description": "Livraison d'un programme de formation complet de 15 heures en analyse de données aux employés du secteur public.",
    "caseStudies.case3.challenge": "Améliorer les compétences de la main-d'œuvre gouvernementale en analyse de données",
    ...
    "caseStudies.case4.description": "Création d'un assistant alimenté par IA pour les professionnels du droit afin d'interagir efficacement avec leurs données juridiques.",
    "caseStudies.case4.challenge": "Gestion et interrogation efficaces des données juridiques",
    "caseStudies.case4.solution": "Chatbot IA pour l'interaction avec les documents juridiques",
    ...
    "caseStudies.case5.description": "Conduite d'un programme de formation intensif IA de 16 heures pour les professionnels IT, axé sur les applications pratiques en milieu de travail.",
    "caseStudies.case5.challenge": "Combler le fossé de connaissances IA dans la main-d'œuvre IT",
